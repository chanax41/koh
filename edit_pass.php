                    ...
                    <div class="row">
                        <div class="col-md-12"> 
                            <div class="left-content">
                                <div class="row">
                                <form action="edit_pass_db.php" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                placeholder='<?php echo $row['FirstName']?>' name="firstname" readonly>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="email"><b>นามสกุล </b></label>
                                                <input class="form-control" type="text" value='<?php echo $row['LastName']?>' 
                                                placeholder='<?php echo $row['LastName']?>' name="surname" readonly>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" type="text" value='<?php echo $row['Email']?>' 
                                                    placeholder='<?php echo $row['Email']?>' name="email" readonly>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="email"><b>ยืนยัน E-mail</b></label>
                                                <input class="form-control" type="text"  placeholder="Repeat email" name="email2" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
