	...
	<div class="modal-dialog modal-dialog-centered ">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">แก้ไขหน้าประชาสัมพันธ์</h4>	
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="modal-body">
				<form action="db_update_pr.php" method="post" enctype="multipart/form-data">
					<div class="form-row">
						...
						<hr>
						<div class="form-group col-md-6">
							<label>รูปภาพสำหรับหน้าจองเเพคเกจ</label>
							<input type="file" class="form-control-file" name="img-2">		
						</div>
						<div class="form-group col-md-6">
							<label>รูปภาพที่อัปโหลด</label>
							<img src="../../<?php echo $img_url_book;?>" width="100%">	
						</div>
					</div>
