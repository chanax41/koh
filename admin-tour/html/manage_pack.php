            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">ส่วนจัดการเเพคเกจท่องเที่ยว</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">ส่วนจัดการเเพคเกจท่องเที่ยว</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                      <a class="btn btn-success" href="add_pac.php" role="button"><i class="fa fa-plus-circle"></i> Add Packages</a>
                        <br><br>    
                        <div class="table-responsive">
                            <table id="myTable" class="display nowrap" style="width:100%" class="table">
                                ...
                                <tbody>
                                    <?php
                                        require_once('db_manage_package.php');
                                    if($obj != NULL){
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <a class="btn btn-success btn-sm" href="update_pac.php?name=<?php echo $val->Name; ?>"> Update </a> 
                                                <a class="btn btn-danger btn-sm" href="manage_user.php?UserName22=<?php echo $val->Name; ?>" onclick='return checkdelete()'> Delete </a>
                                            </td>
